 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,j){var q=F.length;F.push(j);e:for(;0<q;){var ie=q-1>>>1,fe=F[ie];if(0<r(fe,j))F[ie]=j,F[q]=fe,q=ie;else break e}}function n(F){return F.length===0?null:F[0]}function i(F){if(F.length===0)return null;var j=F[0],q=F.pop();if(q!==j){F[0]=q;e:for(var ie=0,fe=F.length,ze=fe>>>1;ie<ze;){var We=2*(ie+1)-1,Le=F[We],Z=We+1,de=F[Z];if(0>r(Le,q))Z<fe&&0>r(de,Le)?(F[ie]=de,F[Z]=q,ie=Z):(F[ie]=Le,F[We]=q,ie=We);else if(Z<fe&&0>r(de,q))F[ie]=de,F[Z]=q,ie=Z;else break e}}return j}function r(F,j){var q=F.sortIndex-j.sortIndex;return q!==0?q:F.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],u=1,d=null,f=3,p=!1,v=!1,S=!1,g=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(F){for(var j=n(c);j!==null;){if(j.callback===null)i(c);else if(j.startTime<=F)i(c),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(c)}}function M(F){if(S=!1,_(F),!v)if(n(l)!==null)v=!0,H(A);else{var j=n(c);j!==null&&B(M,j.startTime-F)}}function A(F,j){v=!1,S&&(S=!1,h(x),x=-1),p=!0;var q=f;try{for(_(j),d=n(l);d!==null&&(!(d.expirationTime>j)||F&&!P());){var ie=d.callback;if(typeof ie=="function"){d.callback=null,f=d.priorityLevel;var fe=ie(d.expirationTime<=j);j=t.unstable_now(),typeof fe=="function"?d.callback=fe:d===n(l)&&i(l),_(j)}else i(l);d=n(l)}if(d!==null)var ze=!0;else{var We=n(c);We!==null&&B(M,We.startTime-j),ze=!1}return ze}finally{d=null,f=q,p=!1}}var T=!1,C=null,x=-1,R=5,b=-1;function P(){return!(t.unstable_now()-b<R)}function O(){if(C!==null){var F=t.unstable_now();b=F;var j=!0;try{j=C(!0,F)}finally{j?X():(T=!1,C=null)}}else T=!1}var X;if(typeof m=="function")X=function(){m(O)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,N=K.port2;K.port1.onmessage=O,X=function(){N.postMessage(null)}}else X=function(){g(O,0)};function H(F){C=F,T||(T=!0,X())}function B(F,j){x=g(function(){F(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){v||p||(v=!0,H(A))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(F){switch(f){case 1:case 2:case 3:var j=3;break;default:j=f}var q=f;f=j;try{return F()}finally{f=q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,j){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var q=f;f=F;try{return j()}finally{f=q}},t.unstable_scheduleCallback=function(F,j,q){var ie=t.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?ie+q:ie):q=ie,F){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=q+fe,F={id:u++,callback:j,priorityLevel:F,startTime:q,expirationTime:fe,sortIndex:-1},q>ie?(F.sortIndex=q,e(c,F),n(l)===null&&F===n(c)&&(S?(h(x),x=-1):S=!0,B(M,q-ie))):(F.sortIndex=fe,e(l,F),v||p||(v=!0,H(A))),F},t.unstable_shouldYield=P,t.unstable_wrapCallback=function(F){var j=f;return function(){var q=f;f=j;try{return F.apply(this,arguments)}finally{f=q}}}})(Z_);$_.exports=Z_;var tT=$_.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wi,depthTest:!1,depthWrite:!1})}function Q2(t,e,n){const i=new Float32Array(qr),r=new G(0,1,0);return new ui({name:"SphericalGaussianBlur",defines:{n:qr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Tu(),fragmentShader:`
	...
	`}class xE extends Ci{constructor(e=1,n={}){super(e,e,n),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new hE(r),this._setTextureOptions(n),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,n){this.texture.type=n.type,this.texture.colorSpace=n.colorSpace,this.texture.generateMipmaps=n.generateMipmaps,this.texture.minFilter=n.minFilter,this.texture.magFilter=n.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Ya(5,5,5),s=new ui({name:"CubemapFromEquirect",uniforms:yo(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Sn,blending:Wi});s.uniforms.tEquirect.value=n;const o=new Pi(r,s),a=n.minFilter;return n.minFilter===ts&&(n.minFilter=rn),new rD(1,10,this).update(e,o),n.minFilter=a,o.geometry.dispose(),o.material.dispose(),this}clear(e,n=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let o=0;o<6;o++)e.setRenderTarget(this,o),e.clear(n,i,r);e.setRenderTarget(s)}}function J2(t){let e=new WeakMap,n=new WeakMap,i=null;function r(f,p=!1){return f==null?null:p?o(f):s(f)}function s(f){if(f&&f.isTexture){const p=f.mapping;if(p===xf||p===yf)if(e.has(f)){const v=e.get(f).texture;return a(v,f.mapping)}else{const v=f.image;if(v&&v.height>0){const S=new xE(v.height);return S.fromEquirectangularTexture(t,f),e.set(f,S),f.addEventListener("dispose",c),a(S.texture,f.mapping)}else return null}}return f}function o(f){if(f&&f.isTexture){const p=f.mapping,v=p===xf||p===yf,S=p===ds||p===_o;if(v||S){let g=n.get(f);const h=g!==void 0?g.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==h)return i===null&&(i=new v_(t)),g=v?i.fromEquirectangular(f,g):i.fromCubemap(f,g),g.texture.pmremVersion=f.pmremVersion,n.set(f,g),g.texture;if(g!==void 0)return g.texture;{const m=f.image;return v&&m&&m.height>0||S&&m&&l(m)?(i===null&&(i=new v_(t)),g=v?i.fromEquirectangular(f):i.fromCubemap(f),g.texture.pmremVersion=f.pmremVersion,n.set(f,g),f.addEventListener("dispose",u),g.texture):null}}}return f}function a(f,p){return p===xf?f.mapping=ds:p===yf&&(f.mapping=_o),f}function l(f){let p=0;const v=6;for(let S=0;S<v;S++)f[S]!==void 0&&p++;return p===v}function c(f){const p=f.target;p.removeEventListener("dispose",c);const v=e.get(p);v!==void 0&&(e.delete(p),v.dispose())}function u(f){const p=f.target;p.removeEventListener("dispose",u);const v=n.get(p);v!==void 0&&(n.delete(p),v.dispose())}function d(){e=new WeakMap,n=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:d}}function eN(t){const e={};function n(i){if(e[i]!==void 0)return e[i];const r=t.getExtension(i);return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&ip("WebGLRenderer: "+i+" extension not supported."),r}}}function tN(t,e,n,i){const r={},s=new WeakMap;function o(d){const f=d.target;f.index!==null&&e.remove(f.index);for(const v in f.attributes)e.remove(f.attributes[v]);f.removeEventListener("dispose",o),delete r[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),i.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,n.memory.geometries--}function a(d,f){return r[f.id]===!0||(f.addEventListener("dispose",o),r[f.id]=!0,n.memory.geometries++),f}function l(d){const f=d.attributes;for(const p in f)e.update(f[p],t.ARRAY_BUFFER)}function c(d){const f=[],p=d.index,v=d.attributes.position;let S=0;if(v===void 0)return;if(p!==null){const m=p.array;S=p.version;for(let _=0,M=m.length;_<M;_+=3){const A=m[_+0],T=m[_+1],C=m[_+2];f.push(A,T,T,C,C,A)}}else{const m=v.array;S=v.version;for(let _=0,M=m.length/3-1;_<M;_+=3){const A=_+0,T=_+1,C=_+2;f.push(A,T,T,C,C,A)}}const g=new(v.count>=65535?uE:cE)(f,1);g.version=S;const h=s.get(d);h&&e.remove(h),s.set(d,g)}function u(d){const f=s.get(d);if(f){const p=d.index;p!==null&&f.version<p.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:u}}function nN(t,e,n){let i;function r(d){i=d}let s,o;function a(d){s=d.type,o=d.bytesPerElement}function l(d,f){t.drawElements(i,f,s,d*o),n.update(f,i,1)}function c(d,f,p){p!==0&&(t.drawElementsInstanced(i,f,s,d*o,p),n.update(f,i,p))}function u(d,f,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,f,0,s,d,0,p);let S=0;for(let g=0;g<p;g++)S+=f[g];n.update(S,i,1)}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function iN(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(s/3);break;case t.LINES:n.lines+=a*(s/2);break;case t.LINE_STRIP:n.lines+=a*(s-1);break;case t.LINE_LOOP:n.lines+=a*s;break;case t.POINTS:n.points+=a*s;break;default:$e("WebGLInfo: Unknown draw mode:",o);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function rN(t,e,n){const i=new WeakMap,r=new Pt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=u!==void 0?u.length:0;let f=i.get(a);if(f===void 0||f.count!==d){let b=function(){x.dispose(),i.delete(a),a.removeEventListener("dispose",b)};var p=b;f!==void 0&&f.texture.dispose();const v=a.morphAttributes.position!==void 0,S=a.morphAttributes.normal!==void 0,g=a.morphAttributes.color!==void 0,h=a.morphAttributes.position||[],m=a.morphAttributes.normal||[],_=a.morphAttributes.color||[];let M=0;v===!0&&(M=1),S===!0&&(M=2),g===!0&&(M=3);let A=a.attributes.position.count*M,T=1;A>e.maxTextureSize&&(T=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const C=new Float32Array(A*T*4*d),x=new oE(C,A,T,d);x.type=Si,x.needsUpdate=!0;const R=M*4;for(let P=0;P<d;P++){const O=h[P],X=m[P],K=_[P],N=A*T*4*P;for(let H=0;H<O.count;H++){const B=H*R;v===!0&&(r.fromBufferAttribute(O,H),C[N+B+0]=r.x,C[N+B+1]=r.y,C[N+B+2]=r.z,C[N+B+3]=0),S===!0&&(r.fromBufferAttribute(X,H),C[N+B+4]=r.x,C[N+B+5]=r.y,C[N+B+6]=r.z,C[N+B+7]=0),g===!0&&(r.fromBufferAttribute(K,H),C[N+B+8]=r.x,C[N+B+9]=r.y,C[N+B+10]=r.z,C[N+B+11]=K.itemSize===4?r.w:1)}}f={count:d,texture:x,size:new nt(A,T)},i.set(a,f),a.addEventListener("dispose",b)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let v=0;for(let g=0;g<c.length;g++)v+=c[g];const S=a.morphTargetsRelative?1:1-v;l.getUniforms().setValue(t,"morphTargetBaseInfluence",S),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",f.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",f.size)}return{update:s}}function sN(t,e,n,i,r){let s=new WeakMap;function o(c){const u=r.render.frame,d=c.geometry,f=e.get(c,d);if(s.get(f)!==u&&(e.update(f),s.set(f,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==u&&(n.update(c.instanceMatrix,t.ARRAY_BUFFER),c.instanceColor!==null&&n.update(c.instanceColor,t.ARRAY_BUFFER),s.set(c,u))),c.isSkinnedMesh){const p=c.skeleton;s.get(p)!==u&&(p.update(),s.set(p,u))}return f}function a(){s=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),i.releaseStatesOfObject(u),n.remove(u.instanceMatrix),u.instanceColor!==null&&n.remove(u.instanceColor)}return{update:o,dispose:a}}const oN={[WM]:"LINEAR_TONE_MAPPING",[jM]:"REINHARD_TONE_MAPPING",[XM]:"CINEON_TONE_MAPPING",[YM]:"ACES_FILMIC_TONE_MAPPING",[qM]:"AGX_TONE_MAPPING",[$M]:"NEUTRAL_TONE_MAPPING",[KM]:"CUSTOM_TONE_MAPPING"};function aN(t,e,n,i,r){const s=new Ci(e,n,{type:t,depthBuffer:i,stencilBuffer:r,depthTexture:i?new xo(e,n):void 0}),o=new Ci(e,n,{type:Zi,depthBuffer:!1,stencilBuffer:!1}),a=new er;a.setAttribute("position",new Xi([-1,3,0,-1,-1,0,3,-1,0],3)),a.setAttribute("uv",new Xi([0,2,0,0,2,0],2));const l=new tD({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`)+`
`+h);const _=m+g+o,M=m+h+a,A=C_(r,r.VERTEX_SHADER,_),T=C_(r,r.FRAGMENT_SHADER,M);r.attachShader(S,A),r.attachShader(S,T),n.index0AttributeName!==void 0?r.bindAttribLocation(S,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function C(P){if(t.debug.checkShaderErrors){const O=r.getProgramInfoLog(S)||"",X=r.getShaderInfoLog(A)||"",K=r.getShaderInfoLog(T)||"",N=O.trim(),H=X.trim(),B=K.trim();let F=!0,j=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(F=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,S,A,T);else{const q=b_(r,A,"vertex"),ie=b_(r,T,"fragment");$e("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
...
Program Info Log: `+N+`
`+q+`
`+ie)}else N!==""?De("WebGLProgram: Program Info Log:",N):(H===""||B==="")&&(j=!1);j&&(P.diagnostics={runnable:F,programLog:N,vertexShader:{log:H,prefix:g},fragmentShader:{log:B,prefix:h}})}r.deleteShader(A),r.deleteShader(T),x=new pc(r,S),R=lI(r,S)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let R;this.getAttributes=function(){return R===void 0&&C(this),R};let b=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return b===!1&&(b=r.getProgramParameter(S,QN)),b},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(S),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=JN++,this.cacheKey=e,this.usedTimes=1,this.program=S,this.vertexShader=A,this.fragmentShader=T,this}let TI=0;class wI{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new AI(e),n.set(e,i)),i}}class AI{constructor(e){this.id=TI++,this.code=e,this.usedTimes=0}}function CI(t){return t===hs||t===qc||t===$c}function RI(t,e,n,i,r,s){const o=new aE,a=new wI,l=new Set,c=[],u=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(x){return l.add(x),x===0?"uv":`uv${x}`}function S(x,R,b,P,O,X){const K=P.fog,N=O.geometry,H=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?P.environment:null,B=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,F=e.get(x.envMap||H,B),j=F&&F.mapping===Mu?F.image.height:null,q=p[x.type];x.precision!==null&&(f=i.getMaxPrecision(x.precision),f!==x.precision&&De("WebGLProgram.getParameters:",x.precision,"not supported, using",f,"instead."));const ie=N.morphAttributes.position||N.morphAttributes.normal||N.morphAttributes.color,fe=ie!==void 0?ie.length:0;let ze=0;N.morphAttributes.position!==void 0&&(ze=1),N.morphAttributes.normal!==void 0&&(ze=2),N.morphAttributes.color!==void 0&&(ze=3);let We,Le,Z,de;if(q){const Fe=xi[q];We=Fe.vertexShader,Le=Fe.fragmentShader}else We=x.vertexShader,Le=x.fragmentShader,a.update(x),Z=a.getVertexShaderID(x),de=a.getFragmentShaderID(x);const ae=t.getRenderTarget(),be=t.state.buffers.depth.getReversed(),Ie=O.isInstancedMesh===!0,Pe=O.isBatchedMesh===!0,vt=!!x.map,je=!!x.matcap,it=!!F,dt=!!x.aoMap,He=!!x.lightMap,It=!!x.bumpMap,_t=!!x.normalMap,Mn=!!x.displacementMap,I=!!x.emissiveMap,Ut=!!x.metalnessMap,Xe=!!x.roughnessMap,ct=x.anisotropy>0,he=x.clearcoat>0,Mt=x.dispersion>0,w=x.iridescence>0,y=x.sheen>0,k=x.transmission>0,Q=ct&&!!x.anisotropyMap,te=he&&!!x.clearcoatMap,re=he&&!!x.clearcoatNormalMap,ue=he&&!!x.clearcoatRoughnessMap,Y=w&&!!x.iridescenceMap,J=w&&!!x.iridescenceThicknessMap,_e=y&&!!x.sheenColorMap,Se=y&&!!x.sheenRoughnessMap,le=!!x.specularMap,se=!!x.specularColorMap,Ne=!!x.specularIntensityMap,ke=k&&!!x.transmissionMap,Je=k&&!!x.thicknessMap,L=!!x.gradientMap,oe=!!x.alphaMap,$=x.alphaTest>0,xe=!!x.alphaHash,ce=!!x.extensions;let ee=Ai;x.toneMapped&&(ae===null||ae.isXRRenderTarget===!0)&&(ee=t.toneMapping);const Ae={shaderID:q,shaderType:x.type,shaderName:x.name,vertexShader:We,fragmentShader:Le,defines:x.defines,customVertexShaderID:Z,customFragmentShaderID:de,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:f,batching:Pe,batchingColor:Pe&&O._colorsTexture!==null,instancing:Ie,instancingColor:Ie&&O.instanceColor!==null,instancingMorph:Ie&&O.morphTexture!==null,outputColorSpace:ae===null?t.outputColorSpace:ae.isXRRenderTarget===!0?ae.texture.colorSpace:Ye.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:vt,matcap:je,envMap:it,envMapMode:it&&F.mapping,envMapCubeUVHeight:j,aoMap:dt,lightMap:He,bumpMap:It,normalMap:_t,displacementMap:Mn,emissiveMap:I,normalMapObjectSpace:_t&&x.normalMapType===p3,normalMapTangentSpace:_t&&x.normalMapType===Wv,packedNormalMap:_t&&x.normalMapType===Wv&&CI(x.normalMap.format),metalnessMap:Ut,roughnessMap:Xe,anisotropy:ct,anisotropyMap:Q,clearcoat:he,clearcoatMap:te,clearcoatNormalMap:re,clearcoatRoughnessMap:ue,dispersion:Mt,iridescence:w,iridescenceMap:Y,iridescenceThicknessMap:J,sheen:y,sheenColorMap:_e,sheenRoughnessMap:Se,specularMap:le,specularColorMap:se,specularIntensityMap:Ne,transmission:k,transmissionMap:ke,thicknessMap:Je,gradientMap:L,opaque:x.transparent===!1&&x.blending===ro&&x.alphaToCoverage===!1,alphaMap:oe,alphaTest:$,alphaHash:xe,combine:x.combine,mapUv:vt&&v(x.map.channel),aoMapUv:dt&&v(x.aoMap.channel),lightMapUv:He&&v(x.lightMap.channel),bumpMapUv:It&&v(x.bumpMap.channel),normalMapUv:_t&&v(x.normalMap.channel),displacementMapUv:Mn&&v(x.displacementMap.channel),emissiveMapUv:I&&v(x.emissiveMap.channel),metalnessMapUv:Ut&&v(x.metalnessMap.channel),roughnessMapUv:Xe&&v(x.roughnessMap.channel),anisotropyMapUv:Q&&v(x.anisotropyMap.channel),clearcoatMapUv:te&&v(x.clearcoatMap.channel),clearcoatNormalMapUv:re&&v(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ue&&v(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Y&&v(x.iridescenceMap.channel),iridescenceThicknessMapUv:J&&v(x.iridescenceThicknessMap.channel),sheenColorMapUv:_e&&v(x.sheenColorMap.channel),sheenRoughnessMapUv:Se&&v(x.sheenRoughnessMap.channel),specularMapUv:le&&v(x.specularMap.channel),specularColorMapUv:se&&v(x.specularColorMap.channel),specularIntensityMapUv:Ne&&v(x.specularIntensityMap.channel),transmissionMapUv:ke&&v(x.transmissionMap.channel),thicknessMapUv:Je&&v(x.thicknessMap.channel),alphaMapUv:oe&&v(x.alphaMap.channel),vertexTangents:!!N.attributes.tangent&&(_t||ct),vertexNormals:!!N.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!N.attributes.color&&N.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!N.attributes.uv&&(vt||oe),fog:!!K,useFog:x.fog===!0,fogExp2:!!K&&K.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||N.attributes.normal===void 0&&_t===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:be,skinning:O.isSkinnedMesh===!0,morphTargets:N.morphAttributes.position!==void 0,morphNormals:N.morphAttributes.normal!==void 0,morphColors:N.morphAttributes.color!==void 0,morphTargetsCount:fe,morphTextureStride:ze,numDirLights:R.directional.length,numPointLights:R.point.length,numSpotLights:R.spot.length,numSpotLightMaps:R.spotLightMap.length,numRectAreaLights:R.rectArea.length,numHemiLights:R.hemi.length,numDirLightShadows:R.directionalShadowMap.length,numPointLightShadows:R.pointShadowMap.length,numSpotLightShadows:R.spotShadowMap.length,numSpotLightShadowsWithMaps:R.numSpotLightShadowsWithMaps,numLightProbes:R.numLightProbes,numLightProbeGrids:X.length,numClippingPlanes:s.numPlanes,numClipIntersection:s.numIntersection,dithering:x.dithering,shadowMapEnabled:t.shadowMap.enabled&&b.length>0,shadowMapType:t.shadowMap.type,toneMapping:ee,decodeVideoTexture:vt&&x.map.isVideoTexture===!0&&Ye.getTransfer(x.map.colorSpace)===et,decodeVideoTextureEmissive:I&&x.emissiveMap.isVideoTexture===!0&&Ye.getTransfer(x.emissiveMap.colorSpace)===et,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Bi,flipSided:x.side===Sn,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ce&&x.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&x.extensions.multiDraw===!0||Pe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Ae.vertexUv1s=l.has(1),Ae.vertexUv2s=l.has(2),Ae.vertexUv3s=l.has(3),l.clear(),Ae}function g(x){const R=[];if(x.shaderID?R.push(x.shaderID):(R.push(x.customVertexShaderID),R.push(x.customFragmentShaderID)),x.defines!==void 0)for(const b in x.defines)R.push(b),R.push(x.defines[b]);return x.isRawShaderMaterial===!1&&(h(R,x),m(R,x),R.push(t.outputColorSpace)),R.push(x.customProgramCacheKey),R.join()}function h(x,R){x.push(R.precision),x.push(R.outputColorSpace),x.push(R.envMapMode),x.push(R.envMapCubeUVHeight),x.push(R.mapUv),x.push(R.alphaMapUv),x.push(R.lightMapUv),x.push(R.aoMapUv),x.push(R.bumpMapUv),x.push(R.normalMapUv),x.push(R.displacementMapUv),x.push(R.emissiveMapUv),x.push(R.metalnessMapUv),x.push(R.roughnessMapUv),x.push(R.anisotropyMapUv),x.push(R.clearcoatMapUv),x.push(R.clearcoatNormalMapUv),x.push(R.clearcoatRoughnessMapUv),x.push(R.iridescenceMapUv),x.push(R.iridescenceThicknessMapUv),x.push(R.sheenColorMapUv),x.push(R.sheenRoughnessMapUv),x.push(R.specularMapUv),x.push(R.specularColorMapUv),x.push(R.specularIntensityMapUv),x.push(R.transmissionMapUv),x.push(R.thicknessMapUv),x.push(R.combine),x.push(R.fogExp2),x.push(R.sizeAttenuation),x.push(R.morphTargetsCount),x.push(R.morphAttributeCount),x.push(R.numDirLights),x.push(R.numPointLights),x.push(R.numSpotLights),x.push(R.numSpotLightMaps),x.push(R.numHemiLights),x.push(R.numRectAreaLights),x.push(R.numDirLightShadows),x.push(R.numPointLightShadows),x.push(R.numSpotLightShadows),x.push(R.numSpotLightShadowsWithMaps),x.push(R.numLightProbes),x.push(R.shadowMapType),x.push(R.toneMapping),x.push(R.numClippingPlanes),x.push(R.numClipIntersection),x.push(R.depthPacking)}function m(x,R){o.disableAll(),R.instancing&&o.enable(0),R.instancingColor&&o.enable(1),R.instancingMorph&&o.enable(2),R.matcap&&o.enable(3),R.envMap&&o.enable(4),R.normalMapObjectSpace&&o.enable(5),R.normalMapTangentSpace&&o.enable(6),R.clearcoat&&o.enable(7),R.iridescence&&o.enable(8),R.alphaTest&&o.enable(9),R.vertexColors&&o.enable(10),R.vertexAlphas&&o.enable(11),R.vertexUv1s&&o.enable(12),R.vertexUv2s&&o.enable(13),R.vertexUv3s&&o.enable(14),R.vertexTangents&&o.enable(15),R.anisotropy&&o.enable(16),R.alphaHash&&o.enable(17),R.batching&&o.enable(18),R.dispersion&&o.enable(19),R.batchingColor&&o.enable(20),R.gradientMap&&o.enable(21),R.packedNormalMap&&o.enable(22),R.vertexNormals&&o.enable(23),x.push(o.mask),o.disableAll(),R.fog&&o.enable(0),R.useFog&&o.enable(1),R.flatShading&&o.enable(2),R.logarithmicDepthBuffer&&o.enable(3),R.reversedDepthBuffer&&o.enable(4),R.skinning&&o.enable(5),R.morphTargets&&o.enable(6),R.morphNormals&&o.enable(7),R.morphColors&&o.enable(8),R.premultipliedAlpha&&o.enable(9),R.shadowMapEnabled&&o.enable(10),R.doubleSided&&o.enable(11),R.flipSided&&o.enable(12),R.useDepthPacking&&o.enable(13),R.dithering&&o.enable(14),R.transmission&&o.enable(15),R.sheen&&o.enable(16),R.opaque&&o.enable(17),R.pointsUvs&&o.enable(18),R.decodeVideoTexture&&o.enable(19),R.decodeVideoTextureEmissive&&o.enable(20),R.alphaToCoverage&&o.enable(21),R.numLightProbeGrids>0&&o.enable(22),x.push(o.mask)}function _(x){const R=p[x.type];let b;if(R){const P=xi[R];b=Q3.clone(P.uniforms)}else b=x.uniforms;return b}function M(x,R){let b=u.get(R);return b!==void 0?++b.usedTimes:(b=new EI(t,R,x,r),c.push(b),u.set(R,b)),b}function A(x){if(--x.usedTimes===0){const R=c.indexOf(x);c[R]=c[c.length-1],c.pop(),u.delete(x.cacheKey),x.destroy()}}function T(x){a.remove(x)}function C(){a.dispose()}return{getParameters:S,getProgramCacheKey:g,getUniforms:_,acquireProgram:M,releaseProgram:A,releaseShaderCache:T,programs:c,dispose:C}}function bI(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function PI(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.materialVariant!==e.materialVariant?t.materialVariant-e.materialVariant:t.z!==e.z?t.z-e.z:t.id-e.id}function I_(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function U_(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(f){let p=0;return f.isInstancedMesh&&(p+=2),f.isSkinnedMesh&&(p+=1),p}function a(f,p,v,S,g,h){let m=t[e];return m===void 0?(m={id:f.id,object:f,geometry:p,material:v,materialVariant:o(f),groupOrder:S,renderOrder:f.renderOrder,z:g,group:h},t[e]=m):(m.id=f.id,m.object=f,m.geometry=p,m.material=v,m.materialVariant=o(f),m.groupOrder=S,m.renderOrder=f.renderOrder,m.z=g,m.group=h),e++,m}function l(f,p,v,S,g,h){const m=a(f,p,v,S,g,h);v.transmission>0?i.push(m):v.transparent===!0?r.push(m):n.push(m)}function c(f,p,v,S,g,h){const m=a(f,p,v,S,g,h);v.transmission>0?i.unshift(m):v.transparent===!0?r.unshift(m):n.unshift(m)}function u(f,p){n.length>1&&n.sort(f||PI),i.length>1&&i.sort(p||I_),r.length>1&&r.sort(p||I_)}function d(){for(let f=e,p=t.length;f<p;f++){const v=t[f];if(v.id===null)break;v.id=null,v.object=null,v.geometry=null,v.material=null,v.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:l,unshift:c,finish:d,sort:u}}function DI(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new U_,t.set(i,[o])):r>=s.length?(o=new U_,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function LI(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new G,color:new ot};break;case"SpotLight":n={position:new G,direction:new G,color:new ot,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new G,color:new ot,distance:0,decay:0};break;case"HemisphereLight":n={direction:new G,skyColor:new ot,groundColor:new ot};break;case"RectAreaLight":n={color:new ot,position:new G,halfWidth:new G,halfHeight:new G};break}return t[e.id]=n,n}}}function NI(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new nt,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let II=0;function UI(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function FI(t){const e=new LI,n=NI(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new G);const r=new G,s=new Bt,o=new Bt;function a(c){let u=0,d=0,f=0;for(let R=0;R<9;R++)i.probe[R].set(0,0,0);let p=0,v=0,S=0,g=0,h=0,m=0,_=0,M=0,A=0,T=0,C=0;c.sort(UI);for(let R=0,b=c.length;R<b;R++){const P=c[R],O=P.color,X=P.intensity,K=P.distance;let N=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===hs?N=P.shadow.map.texture:N=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)u+=O.r*X,d+=O.g*X,f+=O.b*X;else if(P.isLightProbe){for(let H=0;H<9;H++)i.probe[H].addScaledVector(P.sh.coefficients[H],X);C++}else if(P.isDirectionalLight){const H=e.get(P);if(H.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const B=P.shadow,F=n.get(P);F.shadowIntensity=B.intensity,F.shadowBias=B.bias,F.shadowNormalBias=B.normalBias,F.shadowRadius=B.radius,F.shadowMapSize=B.mapSize,i.directionalShadow[p]=F,i.directionalShadowMap[p]=N,i.directionalShadowMatrix[p]=P.shadow.matrix,m++}i.directional[p]=H,p++}else if(P.isSpotLight){const H=e.get(P);H.position.setFromMatrixPosition(P.matrixWorld),H.color.copy(O).multiplyScalar(X),H.distance=K,H.coneCos=Math.cos(P.angle),H.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),H.decay=P.decay,i.spot[S]=H;const B=P.shadow;if(P.map&&(i.spotLightMap[A]=P.map,A++,B.updateMatrices(P),P.castShadow&&T++),i.spotLightMatrix[S]=B.matrix,P.castShadow){const F=n.get(P);F.shadowIntensity=B.intensity,F.shadowBias=B.bias,F.shadowNormalBias=B.normalBias,F.shadowRadius=B.radius,F.shadowMapSize=B.mapSize,i.spotShadow[S]=F,i.spotShadowMap[S]=N,M++}S++}else if(P.isRectAreaLight){const H=e.get(P);H.color.copy(O).multiplyScalar(X),H.halfWidth.set(P.width*.5,0,0),H.halfHeight.set(0,P.height*.5,0),i.rectArea[g]=H,g++}else if(P.isPointLight){const H=e.get(P);if(H.color.copy(P.color).multiplyScalar(P.intensity),H.distance=P.distance,H.decay=P.decay,P.castShadow){const B=P.shadow,F=n.get(P);F.shadowIntensity=B.intensity,F.shadowBias=B.bias,F.shadowNormalBias=B.normalBias,F.shadowRadius=B.radius,F.shadowMapSize=B.mapSize,F.shadowCameraNear=B.camera.near,F.shadowCameraFar=B.camera.far,i.pointShadow[v]=F,i.pointShadowMap[v]=N,i.pointShadowMatrix[v]=P.shadow.matrix,_++}i.point[v]=H,v++}else if(P.isHemisphereLight){const H=e.get(P);H.skyColor.copy(P.color).multiplyScalar(X),H.groundColor.copy(P.groundColor).multiplyScalar(X),i.hemi[h]=H,h++}}g>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=pe.LTC_FLOAT_1,i.rectAreaLTC2=pe.LTC_FLOAT_2):(i.rectAreaLTC1=pe.LTC_HALF_1,i.rectAreaLTC2=pe.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=d,i.ambient[2]=f;const x=i.hash;(x.directionalLength!==p||x.pointLength!==v||x.spotLength!==S||x.rectAreaLength!==g||x.hemiLength!==h||x.numDirectionalShadows!==m||x.numPointShadows!==_||x.numSpotShadows!==M||x.numSpotMaps!==A||x.numLightProbes!==C)&&(i.directional.length=p,i.spot.length=S,i.rectArea.length=g,i.point.length=v,i.hemi.length=h,i.directionalShadow.length=m,i.directionalShadowMap.length=m,i.pointShadow.length=_,i.pointShadowMap.length=_,i.spotShadow.length=M,i.spotShadowMap.length=M,i.directionalShadowMatrix.length=m,i.pointShadowMatrix.length=_,i.spotLightMatrix.length=M+A-T,i.spotLightMap.length=A,i.numSpotLightShadowsWithMaps=T,i.numLightProbes=C,x.directionalLength=p,x.pointLength=v,x.spotLength=S,x.rectAreaLength=g,x.hemiLength=h,x.numDirectionalShadows=m,x.numPointShadows=_,x.numSpotShadows=M,x.numSpotMaps=A,x.numLightProbes=C,i.version=II++)}function l(c,u){let d=0,f=0,p=0,v=0,S=0;const g=u.matrixWorldInverse;for(let h=0,m=c.length;h<m;h++){const _=c[h];if(_.isDirectionalLight){const M=i.directional[d];M.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),d++}else if(_.isSpotLight){const M=i.spot[p];M.position.setFromMatrixPosition(_.matrixWorld),M.position.applyMatrix4(g),M.direction.setFromMatrixPosition(_.matrixWorld),r.setFromMatrixPosition(_.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(g),p++}else if(_.isRectAreaLight){const M=i.rectArea[v];M.position.setFromMatrixPosition(_.matrixWorld),M.position.applyMatrix4(g),o.identity(),s.copy(_.matrixWorld),s.premultiply(g),o.extractRotation(s),M.halfWidth.set(_.width*.5,0,0),M.halfHeight.set(0,_.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),v++}else if(_.isPointLight){const M=i.point[f];M.position.setFromMatrixPosition(_.matrixWorld),M.position.applyMatrix4(g),f++}else if(_.isHemisphereLight){const M=i.hemi[S];M.direction.setFromMatrixPosition(_.matrixWorld),M.direction.transformDirection(g),S++}}}return{setup:a,setupView:l,state:i}}function F_(t){const e=new FI(t),n=[],i=[],r=[];function s(f){d.camera=f,n.length=0,i.length=0,r.length=0}function o(f){n.push(f)}function a(f){i.push(f)}function l(f){r.push(f)}function c(){e.setup(n)}function u(f){e.setupView(n,f)}const d={lightsArray:n,shadowsArray:i,lightProbeGridArray:r,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:s,state:d,setupLights:c,setupLightsView:u,pushLight:o,pushShadow:a,pushLightProbeGrid:l}}function OI(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new F_(t),e.set(r,[a])):s>=o.length?(a=new F_(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}const kI=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,VI=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],zI=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],O_=new Bt,Wo=new G,Zf=new G;function HI(t,e,n){let i=new dE;const r=new nt,s=new nt,o=new Pt,a=new nD,l=new iD,c={},u=n.maxTextureSize,d={[Nr]:Sn,[Sn]:Nr,[Bi]:Bi},f=new ui({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new nt},radius:{value:4}},vertexShader:kI,fragmentShader:BI}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const v=new er;v.setAttribute("position",new Ri(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Pi(v,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cc;let h=this.type;this.render=function(T,C,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||T.length===0)return;this.type===jP&&(De("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=cc);const R=t.getRenderTarget(),b=t.getActiveCubeFace(),P=t.getActiveMipmapLevel(),O=t.state;O.setBlending(Wi),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const X=h!==this.type;X&&C.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(N=>N.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,N=T.length;K<N;K++){const H=T[K],B=H.shadow;if(B===void 0){De("WebGLShadowMap:",H,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const F=B.getFrameExtents();r.multiply(F),s.copy(B.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/F.x),r.x=s.x*F.x,B.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/F.y),r.y=s.y*F.y,B.mapSize.y=s.y));const j=t.state.buffers.depth.getReversed();if(B.camera._reversedDepth=j,B.map===null||X===!0){if(B.map!==null&&(B.map.depthTexture!==null&&(B.map.depthTexture.dispose(),B.map.depthTexture=null),B.map.dispose()),this.type===Zo){if(H.isPointLight){De("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}B.map=new Ci(r.x,r.y,{format:hs,type:Zi,minFilter:rn,magFilter:rn,generateMipmaps:!1}),B.map.texture.name=H.name+".shadowMap",B.map.depthTexture=new xo(r.x,r.y,Si),B.map.depthTexture.name=H.name+".shadowMapDepth",B.map.depthTexture.format=Qi,B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Kt,B.map.depthTexture.magFilter=Kt}else H.isPointLight?(B.map=new xE(r.x),B.map.depthTexture=new $3(r.x,bi)):(B.map=new Ci(r.x,r.y),B.map.depthTexture=new xo(r.x,r.y,bi)),B.map.depthTexture.name=H.name+".shadowMap",B.map.depthTexture.format=Qi,this.type===cc?(B.map.depthTexture.compareFunction=j?Hm:zm,B.map.depthTexture.minFilter=rn,B.map.depthTexture.magFilter=rn):(B.map.depthTexture.compareFunction=null,B.map.depthTexture.minFilter=Kt,B.map.depthTexture.magFilter=Kt);B.camera.updateProjectionMatrix()}const q=B.map.isWebGLCubeRenderTarget?6:1;for(let ie=0;ie<q;ie++){if(B.map.isWebGLCubeRenderTarget)t.setRenderTarget(B.map,ie),t.clear();else{ie===0&&(t.setRenderTarget(B.map),t.clear());const fe=B.getViewport(ie);o.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),O.viewport(o)}if(H.isPointLight){const fe=B.camera,ze=B.matrix,We=H.distance||fe.far;We!==fe.far&&(fe.far=We,fe.updateProjectionMatrix()),Wo.setFromMatrixPosition(H.matrixWorld),fe.position.copy(Wo),Zf.copy(fe.position),Zf.add(VI[ie]),fe.up.copy(zI[ie]),fe.lookAt(Zf),fe.updateMatrixWorld(),ze.makeTranslation(-Wo.x,-Wo.y,-Wo.z),O_.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),B._frustum.setFromProjectionMatrix(O_,fe.coordinateSystem,fe.reversedDepth)}else B.updateMatrices(H);i=B.getFrustum(),M(C,x,B.camera,H,this.type)}B.isPointLightShadow!==!0&&this.type===Zo&&m(B,x),B.needsUpdate=!1}h=this.type,g.needsUpdate=!1,t.setRenderTarget(R,b,P)};function m(T,C){const x=e.update(S);f.defines.VSM_SAMPLES!==T.blurSamples&&(f.defines.VSM_SAMPLES=T.blurSamples,p.defines.VSM_SAMPLES=T.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Ci(r.x,r.y,{format:hs,type:Zi})),f.uniforms.shadow_pass.value=T.map.depthTexture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,t.setRenderTarget(T.mapPass),t.clear(),t.renderBufferDirect(C,null,x,f,S,null),p.uniforms.shadow_pass.value=T.mapPass.texture,p.uniforms.resolution.value=T.mapSize,p.uniforms.radius.value=T.radius,t.setRenderTarget(T.map),t.clear(),t.renderBufferDirect(C,null,x,p,S,null)}function _(T,C,x,R){let b=null;const P=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(P!==void 0)b=P;else if(b=x.isPointLight===!0?l:a,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const O=b.uuid,X=C.uuid;let K=c[O];K===void 0&&(K={},c[O]=K);let N=K[X];N===void 0&&(N=b.clone(),K[X]=N,C.addEventListener("dispose",A)),b=N}if(b.visible=C.visible,b.wireframe=C.wireframe,R===Zo?b.side=C.shadowSide!==null?C.shadowSide:C.side:b.side=C.shadowSide!==null?C.shadowSide:d[C.side],b.alphaMap=C.alphaMap,b.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,b.map=C.map,b.clipShadows=C.clipShadows,b.clippingPlanes=C.clippingPlanes,b.clipIntersection=C.clipIntersection,b.displacementMap=C.displacementMap,b.displacementScale=C.displacementScale,b.displacementBias=C.displacementBias,b.wireframeLinewidth=C.wireframeLinewidth,b.linewidth=C.linewidth,x.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const O=t.properties.get(b);O.light=x}return b}function M(T,C,x,R,b){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&b===Zo)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);const X=e.update(T),K=T.material;if(Array.isArray(K)){const N=X.groups;for(let H=0,B=N.length;H<B;H++){const F=N[H],j=K[F.materialIndex];if(j&&j.visible){const q=_(T,j,R,b);T.onBeforeShadow(t,T,C,x,X,q,F),t.renderBufferDirect(x,null,X,q,T,F),T.onAfterShadow(t,T,C,x,X,q,F)}}}else if(K.visible){const N=_(T,K,R,b);T.onBeforeShadow(t,T,C,x,X,N,null),t.renderBufferDirect(x,null,X,N,T,null),T.onAfterShadow(t,T,C,x,X,N,null)}}const O=T.children;for(let X=0,K=O.length;X<K;X++)M(O[X],C,x,R,b)}function A(T){T.target.removeEventListener("dispose",A);for(const x in c){const R=c[x],b=T.target.uuid;b in R&&(R[b].dispose(),delete R[b])}}}function GI(t,e){function n(){let L=!1;const oe=new Pt;let $=null;const xe=new Pt(0,0,0,0);return{setMask:function(ce){$!==ce&&!L&&(t.colorMask(ce,ce,ce,ce),$=ce)},setLocked:function(ce){L=ce},setClear:function(ce,ee,Ae,Fe,At){At===!0&&(ce*=Fe,ee*=Fe,Ae*=Fe),oe.set(ce,ee,Ae,Fe),xe.equals(oe)===!1&&(t.clearColor(ce,ee,Ae,Fe),xe.copy(oe))},reset:function(){L=!1,$=null,xe.set(-1,0,0,0)}}}function i(){let L=!1,oe=!1,$=null,xe=null,ce=null;return{setReversed:function(ee){if(oe!==ee){const Ae=e.get("EXT_clip_control");ee?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),oe=ee;const Fe=ce;ce=null,this.setClear(Fe)}},getReversed:function(){return oe},setTest:function(ee){ee?ae(t.DEPTH_TEST):be(t.DEPTH_TEST)},setMask:function(ee){$!==ee&&!L&&(t.depthMask(ee),$=ee)},setFunc:function(ee){if(oe&&(ee=T3[ee]),xe!==ee){switch(ee){case _h:t.depthFunc(t.NEVER);break;case xh:t.depthFunc(t.ALWAYS);break;case yh:t.depthFunc(t.LESS);break;case vo:t.depthFunc(t.LEQUAL);break;case Sh:t.depthFunc(t.EQUAL);break;case Mh:t.depthFunc(t.GEQUAL);break;case Eh:t.depthFunc(t.GREATER);break;case Th:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}xe=ee}},setLocked:function(ee){L=ee},setClear:function(ee){ce!==ee&&(ce=ee,oe&&(ee=1-ee),t.clearDepth(ee))},reset:function(){L=!1,$=null,xe=null,ce=null,oe=!1}}}function r(){let L=!1,oe=null,$=null,xe=null,ce=null,ee=null,Ae=null,Fe=null,At=null;return{setTest:function(rt){L||(rt?ae(t.STENCIL_TEST):be(t.STENCIL_TEST))},setMask:function(rt){oe!==rt&&!L&&(t.stencilMask(rt),oe=rt)},setFunc:function(rt,Di,fi){($!==rt||xe!==Di||ce!==fi)&&(t.stencilFunc(rt,Di,fi),$=rt,xe=Di,ce=fi)},setOp:function(rt,Di,fi){(ee!==rt||Ae!==Di||Fe!==fi)&&(t.stencilOp(rt,Di,fi),ee=rt,Ae=Di,Fe=fi)},setLocked:function(rt){L=rt},setClear:function(rt){At!==rt&&(t.clearStencil(rt),At=rt)},reset:function(){L=!1,oe=null,$=null,xe=null,ce=null,ee=null,Ae=null,Fe=null,At=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let u={},d={},f={},p=new WeakMap,v=[],S=null,g=!1,h=null,m=null,_=null,M=null,A=null,T=null,C=null,x=new ot(0,0,0),R=0,b=!1,P=null,O=null,X=null,K=null,N=null;const H=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,F=0;const j=t.getParameter(t.VERSION);j.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(j)[1]),B=F>=1):j.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),B=F>=2);let q=null,ie={};const fe=t.getParameter(t.SCISSOR_BOX),ze=t.getParameter(t.VIEWPORT),We=new Pt().fromArray(fe),Le=new Pt().fromArray(ze);function Z(L,oe,$,xe){const ce=new Uint8Array(4),ee=t.createTexture();t.bindTexture(L,ee),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<$;Ae++)L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY?t.texImage3D(oe,0,t.RGBA,1,1,xe,0,t.RGBA,t.UNSIGNED_BYTE,ce):t.texImage2D(oe+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ce);return ee}const de={};de[t.TEXTURE_2D]=Z(t.TEXTURE_2D,t.TEXTURE_2D,1),de[t.TEXTURE_CUBE_MAP]=Z(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[t.TEXTURE_2D_ARRAY]=Z(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),de[t.TEXTURE_3D]=Z(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ae(t.DEPTH_TEST),o.setFunc(vo),It(!1),_t(Vv),ae(t.CULL_FACE),dt(Wi);function ae(L){u[L]!==!0&&(t.enable(L),u[L]=!0)}function be(L){u[L]!==!1&&(t.disable(L),u[L]=!1)}function Ie(L,oe){return f[L]!==oe?(t.bindFramebuffer(L,oe),f[L]=oe,L===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=oe),L===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=oe),!0):!1}function Pe(L,oe){let $=v,xe=!1;if(L){$=p.get(oe),$===void 0&&($=[],p.set(oe,$));const ce=L.textures;if($.length!==ce.length||$[0]!==t.COLOR_ATTACHMENT0){for(let ee=0,Ae=ce.length;ee<Ae;ee++)$[ee]=t.COLOR_ATTACHMENT0+ee;$.length=ce.length,xe=!0}}else $[0]!==t.BACK&&($[0]=t.BACK,xe=!0);xe&&t.drawBuffers($)}function vt(L){return S!==L?(t.useProgram(L),S=L,!0):!1}const je={[Kr]:t.FUNC_ADD,[YP]:t.FUNC_SUBTRACT,[KP]:t.FUNC_REVERSE_SUBTRACT};je[qP]=t.MIN,je[$P]=t.MAX;const it={[ZP]:t.ZERO,[QP]:t.ONE,[JP]:t.SRC_COLOR,[gh]:t.SRC_ALPHA,[s3]:t.SRC_ALPHA_SATURATE,[i3]:t.DST_COLOR,[t3]:t.DST_ALPHA,[e3]:t.ONE_MINUS_SRC_COLOR,[vh]:t.ONE_MINUS_SRC_ALPHA,[r3]:t.ONE_MINUS_DST_COLOR,[n3]:t.ONE_MINUS_DST_ALPHA,[o3]:t.CONSTANT_COLOR,[a3]:t.ONE_MINUS_CONSTANT_COLOR,[l3]:t.CONSTANT_ALPHA,[c3]:t.ONE_MINUS_CONSTANT_ALPHA};function dt(L,oe,$,xe,ce,ee,Ae,Fe,At,rt){if(L===Wi){g===!0&&(be(t.BLEND),g=!1);return}if(g===!1&&(ae(t.BLEND),g=!0),L!==XP){if(L!==h||rt!==b){if((m!==Kr||A!==Kr)&&(t.blendEquation(t.FUNC_ADD),m=Kr,A=Kr),rt)switch(L){case ro:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case zv:t.blendFunc(t.ONE,t.ONE);break;case Hv:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Gv:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:$e("WebGLState: Invalid blending: ",L);break}else switch(L){case ro:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case zv:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Hv:$e("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Gv:$e("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:$e("WebGLState: Invalid blending: ",L);break}_=null,M=null,T=null,C=null,x.set(0,0,0),R=0,h=L,b=rt}return}ce=ce||oe,ee=ee||$,Ae=Ae||xe,(oe!==m||ce!==A)&&(t.blendEquationSeparate(je[oe],je[ce]),m=oe,A=ce),($!==_||xe!==M||ee!==T||Ae!==C)&&(t.blendFuncSeparate(it[$],it[xe],it[ee],it[Ae]),_=$,M=xe,T=ee,C=Ae),(Fe.equals(x)===!1||At!==R)&&(t.blendColor(Fe.r,Fe.g,Fe.b,At),x.copy(Fe),R=At),h=L,b=!1}function He(L,oe){L.side===Bi?be(t.CULL_FACE):ae(t.CULL_FACE);let $=L.side===Sn;oe&&($=!$),It($),L.blending===ro&&L.transparent===!1?dt(Wi):dt(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),o.setFunc(L.depthFunc),o.setTest(L.depthTest),o.setMask(L.depthWrite),s.setMask(L.colorWrite);const xe=L.stencilWrite;a.setTest(xe),xe&&(a.setMask(L.stencilWriteMask),a.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),a.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),I(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?ae(t.SAMPLE_ALPHA_TO_COVERAGE):be(t.SAMPLE_ALPHA_TO_COVERAGE)}function It(L){P!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),P=L)}function _t(L){L!==GP?(ae(t.CULL_FACE),L!==O&&(L===Vv?t.cullFace(t.BACK):L===WP?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):be(t.CULL_FACE),O=L}function Mn(L){L!==X&&(B&&t.lineWidth(L),X=L)}function I(L,oe,$){L?(ae(t.POLYGON_OFFSET_FILL),(K!==oe||N!==$)&&(K=oe,N=$,o.getReversed()&&(oe=-oe),t.polygonOffset(oe,$))):be(t.POLYGON_OFFSET_FILL)}function Ut(L){L?ae(t.SCISSOR_TEST):be(t.SCISSOR_TEST)}function Xe(L){L===void 0&&(L=t.TEXTURE0+H-1),q!==L&&(t.activeTexture(L),q=L)}function ct(L,oe,$){$===void 0&&(q===null?$=t.TEXTURE0+H-1:$=q);let xe=ie[$];xe===void 0&&(xe={type:void 0,texture:void 0},ie[$]=xe),(xe.type!==L||xe.texture!==oe)&&(q!==$&&(t.activeTexture($),q=$),t.bindTexture(L,oe||de[L]),xe.type=L,xe.texture=oe)}function he(){const L=ie[q];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function Mt(){try{t.compressedTexImage2D(...arguments)}catch(L){$e("WebGLState:",L)}}function w(){try{t.compressedTexImage3D(...arguments)}catch(L){$e("WebGLState:",L)}}function y(){try{t.texSubImage2D(...arguments)}catch(L){$e("WebGLState:",L)}}function k(){try{t.texSubImage3D(...arguments)}catch(L){$e("WebGLState:",L)}}function Q(){try{t.compressedTexSubImage2D(...arguments)}catch(L){$e("WebGLState:",L)}}function te(){try{t.compressedTexSubImage3D(...arguments)}catch(L){$e("WebGLState:",L)}}function re(){try{t.texStorage2D(...arguments)}catch(L){$e("WebGLState:",L)}}function ue(){try{t.texStorage3D(...arguments)}catch(L){$e("WebGLState:",L)}}function Y(){try{t.texImage2D(...arguments)}catch(L){$e("WebGLState:",L)}}function J(){try{t.texImage3D(...arguments)}catch(L){$e("WebGLState:",L)}}function _e(L){return d[L]!==void 0?d[L]:t.getParameter(L)}function Se(L,oe){d[L]!==oe&&(t.pixelStorei(L,oe),d[L]=oe)}function le(L){We.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),We.copy(L))}function se(L){Le.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),Le.copy(L))}function Ne(L,oe){let $=c.get(oe);$===void 0&&($=new WeakMap,c.set(oe,$));let xe=$.get(L);xe===void 0&&(xe=t.getUniformBlockIndex(oe,L.name),$.set(L,xe))}function ke(L,oe){const xe=c.get(oe).get(L);l.get(oe)!==xe&&(t.uniformBlockBinding(oe,xe,L.__bindingPointIndex),l.set(oe,xe))}function Je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),u={},d={},q=null,ie={},f={},p=new WeakMap,v=[],S=null,g=!1,h=null,m=null,_=null,M=null,A=null,T=null,C=null,x=new ot(0,0,0),R=0,b=!1,P=null,O=null,X=null,K=null,N=null,We.set(0,0,t.canvas.width,t.canvas.height),Le.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:ae,disable:be,bindFramebuffer:Ie,drawBuffers:Pe,useProgram:vt,setBlending:dt,setMaterial:He,setFlipSided:It,setCullFace:_t,setLineWidth:Mn,setPolygonOffset:I,setScissorTest:Ut,activeTexture:Xe,bindTexture:ct,unbindTexture:he,compressedTexImage2D:Mt,compressedTexImage3D:w,texImage2D:Y,texImage3D:J,pixelStorei:Se,getParameter:_e,updateUBOMapping:Ne,uniformBlockBinding:ke,texStorage2D:re,texStorage3D:ue,texSubImage2D:y,texSubImage3D:k,compressedTexSubImage2D:Q,compressedTexSubImage3D:te,scissor:le,viewport:se,reset:Je}}function WI(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new nt,u=new WeakMap,d=new Set;let f;const p=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function S(w,y){return v?new OffscreenCanvas(w,y):eu("canvas")}function g(w,y,k){let Q=1;const te=Mt(w);if((te.width>k||te.height>k)&&(Q=k/Math.max(te.width,te.height)),Q<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const re=Math.floor(Q*te.width),ue=Math.floor(Q*te.height);f===void 0&&(f=S(re,ue));const Y=y?S(re,ue):f;return Y.width=re,Y.height=ue,Y.getContext("2d").drawImage(w,0,0,re,ue),De("WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+re+"x"+ue+")."),Y}else return"data"in w&&De("WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),w;return w}function h(w){return w.generateMipmaps}function m(w){t.generateMipmap(w)}function _(w){return w.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:w.isWebGL3DRenderTarget?t.TEXTURE_3D:w.isWebGLArrayRenderTarget||w.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function M(w,y,k,Q,te,re=!1){if(w!==null){if(t[w]!==void 0)return t[w];De("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let ue;Q&&(ue=e.get("EXT_texture_norm16"),ue||De("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=y;if(y===t.RED&&(k===t.FLOAT&&(Y=t.R32F),k===t.HALF_FLOAT&&(Y=t.R16F),k===t.UNSIGNED_BYTE&&(Y=t.R8),k===t.UNSIGNED_SHORT&&ue&&(Y=ue.R16_EXT),k===t.SHORT&&ue&&(Y=ue.R16_SNORM_EXT)),y===t.RED_INTEGER&&(k===t.UNSIGNED_BYTE&&(Y=t.R8UI),k===t.UNSIGNED_SHORT&&(Y=t.R16UI),k===t.UNSIGNED_INT&&(Y=t.R32UI),k===t.BYTE&&(Y=t.R8I),k===t.SHORT&&(Y=t.R16I),k===t.INT&&(Y=t.R32I)),y===t.RG&&(k===t.FLOAT&&(Y=t.RG32F),k===t.HALF_FLOAT&&(Y=t.RG16F),k===t.UNSIGNED_BYTE&&(Y=t.RG8),k===t.UNSIGNED_SHORT&&ue&&(Y=ue.RG16_EXT),k===t.SHORT&&ue&&(Y=ue.RG16_SNORM_EXT)),y===t.RG_INTEGER&&(k===t.UNSIGNED_BYTE&&(Y=t.RG8UI),k===t.UNSIGNED_SHORT&&(Y=t.RG16UI),k===t.UNSIGNED_INT&&(Y=t.RG32UI),k===t.BYTE&&(Y=t.RG8I),k===t.SHORT&&(Y=t.RG16I),k===t.INT&&(Y=t.RG32I)),y===t.RGB_INTEGER&&(k===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),k===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),k===t.UNSIGNED_INT&&(Y=t.RGB32UI),k===t.BYTE&&(Y=t.RGB8I),k===t.SHORT&&(Y=t.RGB16I),k===t.INT&&(Y=t.RGB32I)),y===t.RGBA_INTEGER&&(k===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),k===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),k===t.UNSIGNED_INT&&(Y=t.RGBA32UI),k===t.BYTE&&(Y=t.RGBA8I),k===t.SHORT&&(Y=t.RGBA16I),k===t.INT&&(Y=t.RGBA32I)),y===t.RGB&&(k===t.UNSIGNED_SHORT&&ue&&(Y=ue.RGB16_EXT),k===t.SHORT&&ue&&(Y=ue.RGB16_SNORM_EXT),k===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),k===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),y===t.RGBA){const J=re?Qc:Ye.getTransfer(te);k===t.FLOAT&&(Y=t.RGBA32F),k===t.HALF_FLOAT&&(Y=t.RGBA16F),k===t.UNSIGNED_BYTE&&(Y=J===et?t.SRGB8_ALPHA8:t.RGBA8),k===t.UNSIGNED_SHORT&&ue&&(Y=ue.RGBA16_EXT),k===t.SHORT&&ue&&(Y=ue.RGBA16_SNORM_EXT),k===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),k===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function A(w,y){let k;return w?y===null||y===bi||y===Ua?k=t.DEPTH24_STENCIL8:y===Si?k=t.DEPTH32F_STENCIL8:y===Ia&&(k=t.DEPTH24_STENCIL8,De("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===bi||y===Ua?k=t.DEPTH_COMPONENT24:y===Si?k=t.DEPTH_COMPONENT32F:y===Ia&&(k=t.DEPTH_COMPONENT16),k}function T(w,y){return h(w)===!0||w.isFramebufferTexture&&w.minFilter!==Kt&&w.minFilter!==rn?Math.log2(Math.max(y.width,y.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?y.mipmaps.length:1}function C(w){const y=w.target;y.removeEventListener("dispose",C),R(y),y.isVideoTexture&&u.delete(y),y.isHTMLTexture&&d.delete(y)}function x(w){const y=w.target;y.removeEventListener("dispose",x),P(y)}function R(w){const y=i.get(w);if(y.__webglInit===void 0)return;const k=w.source,Q=p.get(k);if(Q){const te=Q[y.__cacheKey];te.usedTimes--,te.usedTimes===0&&b(w),Object.keys(Q).length===0&&p.delete(k)}i.remove(w)}function b(w){const y=i.get(w);t.deleteTexture(y.__webglTexture);const k=w.source,Q=p.get(k);delete Q[y.__cacheKey],o.memory.textures--}function P(w){const y=i.get(w);if(w.depthTexture&&(w.depthTexture.dispose(),i.remove(w.depthTexture)),w.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(y.__webglFramebuffer[Q]))for(let te=0;te<y.__webglFramebuffer[Q].length;te++)t.deleteFramebuffer(y.__webglFramebuffer[Q][te]);else t.deleteFramebuffer(y.__webglFramebuffer[Q]);y.__webglDepthbuffer&&t.deleteRenderbuffer(y.__webglDepthbuffer[Q])}else{if(Array.isArray(y.__webglFramebuffer))for(let Q=0;Q<y.__webglFramebuffer.length;Q++)t.deleteFramebuffer(y.__webglFramebuffer[Q]);else t.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&t.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&t.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let Q=0;Q<y.__webglColorRenderbuffer.length;Q++)y.__webglColorRenderbuffer[Q]&&t.deleteRenderbuffer(y.__webglColorRenderbuffer[Q]);y.__webglDepthRenderbuffer&&t.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const k=w.textures;for(let Q=0,te=k.length;Q<te;Q++){const re=i.get(k[Q]);re.__webglTexture&&(t.deleteTexture(re.__webglTexture),o.memory.textures--),i.remove(k[Q])}i.remove(w)}let O=0;function X(){O=0}function K(){return O}function N(w){O=w}function H(){const w=O;return w>=r.maxTextures&&De("WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+r.maxTextures),O+=1,w}function B(w){const y=[];return y.push(w.wrapS),y.push(w.wrapT),y.push(w.wrapR||0),y.push(w.magFilter),y.push(w.minFilter),y.push(w.anisotropy),y.push(w.internalFormat),y.push(w.format),y.push(w.type),y.push(w.generateMipmaps),y.push(w.premultiplyAlpha),y.push(w.flipY),y.push(w.unpackAlignment),y.push(w.colorSpace),y.join()}function F(w,y){const k=i.get(w);if(w.isVideoTexture&&ct(w),w.isRenderTargetTexture===!1&&w.isExternalTexture!==!0&&w.version>0&&k.__version!==w.version){const Q=w.image;if(Q===null)De("WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)De("WebGLRenderer: Texture marked for update but image is incomplete");else{be(k,w,y);return}}else w.isExternalTexture&&(k.__webglTexture=w.sourceTexture?w.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,k.__webglTexture,t.TEXTURE0+y)}function j(w,y){const k=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){be(k,w,y);return}else w.isExternalTexture&&(k.__webglTexture=w.sourceTexture?w.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,k.__webglTexture,t.TEXTURE0+y)}function q(w,y){const k=i.get(w);if(w.isRenderTargetTexture===!1&&w.version>0&&k.__version!==w.version){be(k,w,y);return}n.bindTexture(t.TEXTURE_3D,k.__webglTexture,t.TEXTURE0+y)}function ie(w,y){const k=i.get(w);if(w.isCubeDepthTexture!==!0&&w.version>0&&k.__version!==w.version){Ie(k,w,y);return}n.bindTexture(t.TEXTURE_CUBE_MAP,k.__webglTexture,t.TEXTURE0+y)}const fe={[wh]:t.REPEAT,[Hi]:t.CLAMP_TO_EDGE,[Ah]:t.MIRRORED_REPEAT},ze={[Kt]:t.NEAREST,[d3]:t.NEAREST_MIPMAP_NEAREST,[yl]:t.NEAREST_MIPMAP_LINEAR,[rn]:t.LINEAR,[Sf]:t.LINEAR_MIPMAP_NEAREST,[ts]:t.LINEAR_MIPMAP_LINEAR},We={[m3]:t.NEVER,[y3]:t.ALWAYS,[g3]:t.LESS,[zm]:t.LEQUAL,[v3]:t.EQUAL,[Hm]:t.GEQUAL,[_3]:t.GREATER,[x3]:t.NOTEQUAL};function Le(w,y){if(y.type===Si&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===rn||y.magFilter===Sf||y.magFilter===yl||y.magFilter===ts||y.minFilter===rn||y.minFilter===Sf||y.minFilter===yl||y.minFilter===ts)&&De("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(w,t.TEXTURE_WRAP_S,fe[y.wrapS]),t.texParameteri(w,t.TEXTURE_WRAP_T,fe[y.wrapT]),(w===t.TEXTURE_3D||w===t.TEXTURE_2D_ARRAY)&&t.texParameteri(w,t.TEXTURE_WRAP_R,fe[y.wrapR]),t.texParameteri(w,t.TEXTURE_MAG_FILTER,ze[y.magFilter]),t.texParameteri(w,t.TEXTURE_MIN_FILTER,ze[y.minFilter]),y.compareFunction&&(t.texParameteri(w,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(w,t.TEXTURE_COMPARE_FUNC,We[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Kt||y.minFilter!==yl&&y.minFilter!==ts||y.type===Si&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||i.get(y).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");t.texParameterf(w,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,r.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy}}}function Z(w,y){let k=!1;w.__webglInit===void 0&&(w.__webglInit=!0,y.addEventListener("dispose",C));const Q=y.source;let te=p.get(Q);te===void 0&&(te={},p.set(Q,te));const re=B(y);if(re!==w.__cacheKey){te[re]===void 0&&(te[re]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,k=!0),te[re].usedTimes++;const ue=te[w.__cacheKey];ue!==void 0&&(te[w.__cacheKey].usedTimes--,ue.usedTimes===0&&b(y)),w.__cacheKey=re,w.__webglTexture=te[re].texture}return k}function de(w,y,k){return Math.floor(Math.floor(w/k)/y)}function ae(w,y,k,Q){const re=w.updateRanges;if(re.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,y.width,y.height,k,Q,y.data);else{re.sort((Se,le)=>Se.start-le.start);let ue=0;for(let Se=1;Se<re.length;Se++){const le=re[ue],se=re[Se],Ne=le.start+le.count,ke=de(se.start,y.width,4),Je=de(le.start,y.width,4);se.start<=Ne+1&&ke===Je&&de(se.start+se.count-1,y.width,4)===ke?le.count=Math.max(le.count,se.start+se.count-le.start):(++ue,re[ue]=se)}re.length=ue+1;const Y=n.getParameter(t.UNPACK_ROW_LENGTH),J=n.getParameter(t.UNPACK_SKIP_PIXELS),_e=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,y.width);for(let Se=0,le=re.length;Se<le;Se++){const se=re[Se],Ne=Math.floor(se.start/4),ke=Math.ceil(se.count/4),Je=Ne%y.width,L=Math.floor(Ne/y.width),oe=ke,$=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,Je),n.pixelStorei(t.UNPACK_SKIP_ROWS,L),n.texSubImage2D(t.TEXTURE_2D,0,Je,L,oe,$,k,Q,y.data)}w.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,J),n.pixelStorei(t.UNPACK_SKIP_ROWS,_e)}}function be(w,y,k){let Q=t.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(Q=t.TEXTURE_2D_ARRAY),y.isData3DTexture&&(Q=t.TEXTURE_3D);const te=Z(w,y),re=y.source;n.bindTexture(Q,w.__webglTexture,t.TEXTURE0+k);const ue=i.get(re);if(re.version!==ue.__version||te===!0){if(n.activeTexture(t.TEXTURE0+k),(typeof ImageBitmap<"u"&&y.image instanceof ImageBitmap)===!1){const $=Ye.getPrimaries(Ye.workingColorSpace),xe=y.colorSpace===vr?null:Ye.getPrimaries(y.colorSpace),ce=y.colorSpace===vr||$===xe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce)}n.pixelStorei(t.UNPACK_ALIGNMENT,y.unpackAlignment);let J=g(y.image,!1,r.maxTextureSize);J=he(y,J);const _e=s.convert(y.format,y.colorSpace),Se=s.convert(y.type);let le=M(y.internalFormat,_e,Se,y.normalized,y.colorSpace,y.isVideoTexture);Le(Q,y);let se;const Ne=y.mipmaps,ke=y.isVideoTexture!==!0,Je=ue.__version===void 0||te===!0,L=re.dataReady,oe=T(y,J);if(y.isDepthTexture)le=A(y.format===ns,y.type),Je&&(ke?n.texStorage2D(t.TEXTURE_2D,1,le,J.width,J.height):n.texImage2D(t.TEXTURE_2D,0,le,J.width,J.height,0,_e,Se,null));else if(y.isDataTexture)if(Ne.length>0){ke&&Je&&n.texStorage2D(t.TEXTURE_2D,oe,le,Ne[0].width,Ne[0].height);for(let $=0,xe=Ne.length;$<xe;$++)se=Ne[$],ke?L&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,se.width,se.height,_e,Se,se.data):n.texImage2D(t.TEXTURE_2D,$,le,se.width,se.height,0,_e,Se,se.data);y.generateMipmaps=!1}else ke?(Je&&n.texStorage2D(t.TEXTURE_2D,oe,le,J.width,J.height),L&&ae(y,J,_e,Se)):n.texImage2D(t.TEXTURE_2D,0,le,J.width,J.height,0,_e,Se,J.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){ke&&Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,le,Ne[0].width,Ne[0].height,J.depth);for(let $=0,xe=Ne.length;$<xe;$++)if(se=Ne[$],y.format!==ri)if(_e!==null)if(ke){if(L)if(y.layerUpdates.size>0){const ce=p_(se.width,se.height,y.format,y.type);for(const ee of y.layerUpdates){const Ae=se.data.subarray(ee*ce/se.data.BYTES_PER_ELEMENT,(ee+1)*ce/se.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,ee,se.width,se.height,1,_e,Ae)}y.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,0,se.width,se.height,J.depth,_e,se.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,$,le,se.width,se.height,J.depth,0,se.data,0,0);else De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ke?L&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,0,se.width,se.height,J.depth,_e,Se,se.data):n.texImage3D(t.TEXTURE_2D_ARRAY,$,le,se.width,se.height,J.depth,0,_e,Se,se.data)}else{ke&&Je&&n.texStorage2D(t.TEXTURE_2D,oe,le,Ne[0].width,Ne[0].height);for(let $=0,xe=Ne.length;$<xe;$++)se=Ne[$],y.format!==ri?_e!==null?ke?L&&n.compressedTexSubImage2D(t.TEXTURE_2D,$,0,0,se.width,se.height,_e,se.data):n.compressedTexImage2D(t.TEXTURE_2D,$,le,se.width,se.height,0,se.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ke?L&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,se.width,se.height,_e,Se,se.data):n.texImage2D(t.TEXTURE_2D,$,le,se.width,se.height,0,_e,Se,se.data)}else if(y.isDataArrayTexture)if(ke){if(Je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,oe,le,J.width,J.height,J.depth),L)if(y.layerUpdates.size>0){const $=p_(J.width,J.height,y.format,y.type);for(const xe of y.layerUpdates){const ce=J.data.subarray(xe*$/J.data.BYTES_PER_ELEMENT,(xe+1)*$/J.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,xe,J.width,J.height,1,_e,Se,ce)}y.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,_e,Se,J.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,le,J.width,J.height,J.depth,0,_e,Se,J.data);else if(y.isData3DTexture)ke?(Je&&n.texStorage3D(t.TEXTURE_3D,oe,le,J.width,J.height,J.depth),L&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,_e,Se,J.data)):n.texImage3D(t.TEXTURE_3D,0,le,J.width,J.height,J.depth,0,_e,Se,J.data);else if(y.isFramebufferTexture){if(Je)if(ke)n.texStorage2D(t.TEXTURE_2D,oe,le,J.width,J.height);else{let $=J.width,xe=J.height;for(let ce=0;ce<oe;ce++)n.texImage2D(t.TEXTURE_2D,ce,le,$,xe,0,_e,Se,null),$>>=1,xe>>=1}}else if(y.isHTMLTexture){if("texElementImage2D"in t){const $=t.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),J.parentNode!==$){$.appendChild(J),d.add(y),$.onpaint=Fe=>{const At=Fe.changedElements;for(const rt of d)At.includes(rt.image)&&(rt.needsUpdate=!0)},$.requestPaint();return}const xe=0,ce=t.RGBA,ee=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,xe,ce,ee,Ae,J),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(ke&&Je){const $=Mt(Ne[0]);n.texStorage2D(t.TEXTURE_2D,oe,le,$.width,$.height)}for(let $=0,xe=Ne.length;$<xe;$++)se=Ne[$],ke?L&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,_e,Se,se):n.texImage2D(t.TEXTURE_2D,$,le,_e,Se,se);y.generateMipmaps=!1}else if(ke){if(Je){const $=Mt(J);n.texStorage2D(t.TEXTURE_2D,oe,le,$.width,$.height)}L&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e,Se,J)}else n.texImage2D(t.TEXTURE_2D,0,le,_e,Se,J);h(y)&&m(Q),ue.__version=re.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function Ie(w,y,k){if(y.image.length!==6)return;const Q=Z(w,y),te=y.source;n.bindTexture(t.TEXTURE_CUBE_MAP,w.__webglTexture,t.TEXTURE0+k);const re=i.get(te);if(te.version!==re.__version||Q===!0){n.activeTexture(t.TEXTURE0+k);const ue=Ye.getPrimaries(Ye.workingColorSpace),Y=y.colorSpace===vr?null:Ye.getPrimaries(y.colorSpace),J=y.colorSpace===vr||ue===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,y.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,y.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,J);const _e=y.isCompressedTexture||y.image[0].isCompressedTexture,Se=y.image[0]&&y.image[0].isDataTexture,le=[];for(let ee=0;ee<6;ee++)!_e&&!Se?le[ee]=g(y.image[ee],!0,r.maxCubemapSize):le[ee]=Se?y.image[ee].image:y.image[ee],le[ee]=he(y,le[ee]);const se=le[0],Ne=s.convert(y.format,y.colorSpace),ke=s.convert(y.type),Je=M(y.internalFormat,Ne,ke,y.normalized,y.colorSpace),L=y.isVideoTexture!==!0,oe=re.__version===void 0||Q===!0,$=te.dataReady;let xe=T(y,se);Le(t.TEXTURE_CUBE_MAP,y);let ce;if(_e){L&&oe&&n.texStorage2D(t.TEXTURE_CUBE_MAP,xe,Je,se.width,se.height);for(let ee=0;ee<6;ee++){ce=le[ee].mipmaps;for(let Ae=0;Ae<ce.length;Ae++){const Fe=ce[Ae];y.format!==ri?Ne!==null?L?$&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,0,0,Fe.width,Fe.height,Ne,Fe.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,Je,Fe.width,Fe.height,0,Fe.data):De("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,0,0,Fe.width,Fe.height,Ne,ke,Fe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae,Je,Fe.width,Fe.height,0,Ne,ke,Fe.data)}}}else{if(ce=y.mipmaps,L&&oe){ce.length>0&&xe++;const ee=Mt(le[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,xe,Je,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(Se){L?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,le[ee].width,le[ee].height,Ne,ke,le[ee].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Je,le[ee].width,le[ee].height,0,Ne,ke,le[ee].data);for(let Ae=0;Ae<ce.length;Ae++){const At=ce[Ae].image[ee].image;L?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,0,0,At.width,At.height,Ne,ke,At.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,Je,At.width,At.height,0,Ne,ke,At.data)}}else{L?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ne,ke,le[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Je,Ne,ke,le[ee]);for(let Ae=0;Ae<ce.length;Ae++){const Fe=ce[Ae];L?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,0,0,Ne,ke,Fe.image[ee]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ee,Ae+1,Je,Ne,ke,Fe.image[ee])}}}h(y)&&m(t.TEXTURE_CUBE_MAP),re.__version=te.version,y.onUpdate&&y.onUpdate(y)}w.__version=y.version}function Pe(w,y,k,Q,te,re){const ue=s.convert(k.format,k.colorSpace),Y=s.convert(k.type),J=M(k.internalFormat,ue,Y,k.normalized,k.colorSpace),_e=i.get(y),Se=i.get(k);if(Se.__renderTarget=y,!_e.__hasExternalTextures){const le=Math.max(1,y.width>>re),se=Math.max(1,y.height>>re);te===t.TEXTURE_3D||te===t.TEXTURE_2D_ARRAY?n.texImage3D(te,re,J,le,se,y.depth,0,ue,Y,null):n.texImage2D(te,re,J,le,se,0,ue,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,w),Xe(y)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,te,Se.__webglTexture,0,Ut(y)):(te===t.TEXTURE_2D||te>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Q,te,Se.__webglTexture,re),n.bindFramebuffer(t.FRAMEBUFFER,null)}function vt(w,y,k){if(t.bindRenderbuffer(t.RENDERBUFFER,w),y.depthBuffer){const Q=y.depthTexture,te=Q&&Q.isDepthTexture?Q.type:null,re=A(y.stencilBuffer,te),ue=y.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Xe(y)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ut(y),re,y.width,y.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ut(y),re,y.width,y.height):t.renderbufferStorage(t.RENDERBUFFER,re,y.width,y.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,ue,t.RENDERBUFFER,w)}else{const Q=y.textures;for(let te=0;te<Q.length;te++){const re=Q[te],ue=s.convert(re.format,re.colorSpace),Y=s.convert(re.type),J=M(re.internalFormat,ue,Y,re.normalized,re.colorSpace);Xe(y)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ut(y),J,y.width,y.height):k?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ut(y),J,y.width,y.height):t.renderbufferStorage(t.RENDERBUFFER,J,y.width,y.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function je(w,y,k){const Q=y.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,w),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const te=i.get(y.depthTexture);if(te.__renderTarget=y,(!te.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),Q){if(te.__webglInit===void 0&&(te.__webglInit=!0,y.depthTexture.addEventListener("dispose",C)),te.__webglTexture===void 0){te.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,te.__webglTexture),Le(t.TEXTURE_CUBE_MAP,y.depthTexture);const _e=s.convert(y.depthTexture.format),Se=s.convert(y.depthTexture.type);let le;y.depthTexture.format===Qi?le=t.DEPTH_COMPONENT24:y.depthTexture.format===ns&&(le=t.DEPTH24_STENCIL8);for(let se=0;se<6;se++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,le,y.width,y.height,0,_e,Se,null)}}else F(y.depthTexture,0);const re=te.__webglTexture,ue=Ut(y),Y=Q?t.TEXTURE_CUBE_MAP_POSITIVE_X+k:t.TEXTURE_2D,J=y.depthTexture.format===ns?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(y.depthTexture.format===Qi)Xe(y)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,re,0,ue):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,re,0);else if(y.depthTexture.format===ns)Xe(y)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,J,Y,re,0,ue):t.framebufferTexture2D(t.FRAMEBUFFER,J,Y,re,0);else throw new Error("Unknown depthTexture format")}function it(w){const y=i.get(w),k=w.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==w.depthTexture){const Q=w.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),Q){const te=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,Q.removeEventListener("dispose",te)};Q.addEventListener("dispose",te),y.__depthDisposeCallback=te}y.__boundDepthTexture=Q}if(w.depthTexture&&!y.__autoAllocateDepthBuffer)if(k)for(let Q=0;Q<6;Q++)je(y.__webglFramebuffer[Q],w,Q);else{const Q=w.texture.mipmaps;Q&&Q.length>0?je(y.__webglFramebuffer[0],w,0):je(y.__webglFramebuffer,w,0)}else if(k){y.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(n.bindFramebuffer(t.FRAMEBUFFER,y.__webglFramebuffer[Q]),y.__webglDepthbuffer[Q]===void 0)y.__webglDepthbuffer[Q]=t.createRenderbuffer(),vt(y.__webglDepthbuffer[Q],w,!1);else{const te=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=y.__webglDepthbuffer[Q];t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,re)}}else{const Q=w.texture.mipmaps;if(Q&&Q.length>0?n.bindFramebuffer(t.FRAMEBUFFER,y.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=t.createRenderbuffer(),vt(y.__webglDepthbuffer,w,!1);else{const te=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=y.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,re),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,re)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function dt(w,y,k){const Q=i.get(w);y!==void 0&&Pe(Q.__webglFramebuffer,w,w.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),k!==void 0&&it(w)}function He(w){const y=w.texture,k=i.get(w),Q=i.get(y);w.addEventListener("dispose",x);const te=w.textures,re=w.isWebGLCubeRenderTarget===!0,ue=te.length>1;if(ue||(Q.__webglTexture===void 0&&(Q.__webglTexture=t.createTexture()),Q.__version=y.version,o.memory.textures++),re){k.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(y.mipmaps&&y.mipmaps.length>0){k.__webglFramebuffer[Y]=[];for(let J=0;J<y.mipmaps.length;J++)k.__webglFramebuffer[Y][J]=t.createFramebuffer()}else k.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){k.__webglFramebuffer=[];for(let Y=0;Y<y.mipmaps.length;Y++)k.__webglFramebuffer[Y]=t.createFramebuffer()}else k.__webglFramebuffer=t.createFramebuffer();if(ue)for(let Y=0,J=te.length;Y<J;Y++){const _e=i.get(te[Y]);_e.__webglTexture===void 0&&(_e.__webglTexture=t.createTexture(),o.memory.textures++)}if(w.samples>0&&Xe(w)===!1){k.__webglMultisampledFramebuffer=t.createFramebuffer(),k.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let Y=0;Y<te.length;Y++){const J=te[Y];k.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,k.__webglColorRenderbuffer[Y]);const _e=s.convert(J.format,J.colorSpace),Se=s.convert(J.type),le=M(J.internalFormat,_e,Se,J.normalized,J.colorSpace,w.isXRRenderTarget===!0),se=Ut(w);t.renderbufferStorageMultisample(t.RENDERBUFFER,se,le,w.width,w.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,k.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),w.depthBuffer&&(k.__webglDepthRenderbuffer=t.createRenderbuffer(),vt(k.__webglDepthRenderbuffer,w,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(re){n.bindTexture(t.TEXTURE_CUBE_MAP,Q.__webglTexture),Le(t.TEXTURE_CUBE_MAP,y);for(let Y=0;Y<6;Y++)if(y.mipmaps&&y.mipmaps.length>0)for(let J=0;J<y.mipmaps.length;J++)Pe(k.__webglFramebuffer[Y][J],w,y,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,J);else Pe(k.__webglFramebuffer[Y],w,y,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);h(y)&&m(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(ue){for(let Y=0,J=te.length;Y<J;Y++){const _e=te[Y],Se=i.get(_e);let le=t.TEXTURE_2D;(w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(le=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(le,Se.__webglTexture),Le(le,_e),Pe(k.__webglFramebuffer,w,_e,t.COLOR_ATTACHMENT0+Y,le,0),h(_e)&&m(le)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(Y=w.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,Q.__webglTexture),Le(Y,y),y.mipmaps&&y.mipmaps.length>0)for(let J=0;J<y.mipmaps.length;J++)Pe(k.__webglFramebuffer[J],w,y,t.COLOR_ATTACHMENT0,Y,J);else Pe(k.__webglFramebuffer,w,y,t.COLOR_ATTACHMENT0,Y,0);h(y)&&m(Y),n.unbindTexture()}w.depthBuffer&&it(w)}function It(w){const y=w.textures;for(let k=0,Q=y.length;k<Q;k++){const te=y[k];if(h(te)){const re=_(w),ue=i.get(te).__webglTexture;n.bindTexture(re,ue),m(re),n.unbindTexture()}}}const _t=[],Mn=[];function I(w){if(w.samples>0){if(Xe(w)===!1){const y=w.textures,k=w.width,Q=w.height;let te=t.COLOR_BUFFER_BIT;const re=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ue=i.get(w),Y=y.length>1;if(Y)for(let _e=0;_e<y.length;_e++)n.bindFramebuffer(t.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ue.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer);const J=w.texture.mipmaps;J&&J.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ue.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let _e=0;_e<y.length;_e++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(te|=t.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(te|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ue.__webglColorRenderbuffer[_e]);const Se=i.get(y[_e]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,Se,0)}t.blitFramebuffer(0,0,k,Q,0,0,k,Q,te,t.NEAREST),l===!0&&(_t.length=0,Mn.length=0,_t.push(t.COLOR_ATTACHMENT0+_e),w.depthBuffer&&w.resolveDepthBuffer===!1&&(_t.push(re),Mn.push(re),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Mn)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,_t))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let _e=0;_e<y.length;_e++){n.bindFramebuffer(t.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.RENDERBUFFER,ue.__webglColorRenderbuffer[_e]);const Se=i.get(y[_e]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ue.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+_e,t.TEXTURE_2D,Se,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&l){const y=w.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[y])}}}function Ut(w){return Math.min(r.maxSamples,w.samples)}function Xe(w){const y=i.get(w);return w.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function ct(w){const y=o.render.frame;u.get(w)!==y&&(u.set(w,y),w.update())}function he(w,y){const k=w.colorSpace,Q=w.format,te=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||k!==Zc&&k!==vr&&(Ye.getTransfer(k)===et?(Q!==ri||te!==Bn)&&De("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):$e("WebGLTextures: Unsupported texture color space:",k)),y}function Mt(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(c.width=w.naturalWidth||w.width,c.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(c.width=w.displayWidth,c.height=w.displayHeight):(c.width=w.width,c.height=w.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=X,this.getTextureUnits=K,this.setTextureUnits=N,this.setTexture2D=F,this.setTexture2DArray=j,this.setTexture3D=q,this.setTextureCube=ie,this.rebindTextures=dt,this.setupRenderTarget=He,this.updateRenderTargetMipmap=It,this.updateMultisampleRenderTarget=I,this.setupDepthRenderbuffer=it,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=Xe,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function jI(t,e){function n(i,r=vr){let s;const o=Ye.getTransfer(r);if(i===Bn)return t.UNSIGNED_BYTE;if(i===Fm)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Om)return t.UNSIGNED_SHORT_5_5_5_1;if(i===eE)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===tE)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===QM)return t.BYTE;if(i===JM)return t.SHORT;if(i===Ia)return t.UNSIGNED_SHORT;if(i===Um)return t.INT;if(i===bi)return t.UNSIGNED_INT;if(i===Si)return t.FLOAT;if(i===Zi)return t.HALF_FLOAT;if(i===nE)return t.ALPHA;if(i===iE)return t.RGB;if(i===ri)return t.RGBA;if(i===Qi)return t.DEPTH_COMPONENT;if(i===ns)return t.DEPTH_STENCIL;if(i===rE)return t.RED;if(i===km)return t.RED_INTEGER;if(i===hs)return t.RG;if(i===Bm)return t.RG_INTEGER;if(i===Vm)return t.RGBA_INTEGER;if(i===uc||i===fc||i===dc||i===hc)if(o===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===uc)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===fc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===dc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===hc)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===uc)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===fc)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===dc)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===hc)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ch||i===Rh||i===bh||i===Ph)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ch)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Rh)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===bh)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Ph)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Dh||i===Lh||i===Nh||i===Ih||i===Uh||i===qc||i===Fh)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Dh||i===Lh)return o===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Nh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===Ih)return s.COMPRESSED_R11_EAC;if(i===Uh)return s.COMPRESSED_SIGNED_R11_EAC;if(i===qc)return s.COMPRESSED_RG11_EAC;if(i===Fh)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Oh||i===kh||i===Bh||i===Vh||i===zh||i===Hh||i===Gh||i===Wh||i===jh||i===Xh||i===Yh||i===Kh||i===qh||i===$h)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Oh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===kh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Bh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Vh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===zh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Hh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Gh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Wh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===jh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Xh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Yh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Kh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===qh)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===$h)return o===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Zh||i===Qh||i===Jh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Zh)return o===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Qh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Jh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===ep||i===tp||i===$c||i===np)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===ep)return s.COMPRESSED_RED_RGTC1_EXT;if(i===tp)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===$c)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===np)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ua?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const XI=`
void main() {
